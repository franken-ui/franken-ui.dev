...
<Ec path="slideshow.20" />

Shows the slideshow item.

#### startAutoplay

<Ec path="slideshow.21" />

Starts the slideshow autoplay.

#### stopAutoplay

<Ec path="slideshow.22" />
